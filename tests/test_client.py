    ...
    [
        {
            ...
            "country": "Allemagne",
            "country_code": "de",
            "lon": 6.514218325709599,
            "lat": 51.36440725,
            "formatted": "Hülser Markt 1, 47839 Krefeld, Allemagne",
            "address_line1": "Hülser Markt 1",
            "address_line2": "47839 Krefeld, Allemagne",
            "category": "building",
            "result_type": "building",
            "rank": {
                "importance": 0.21100000000000002,
                "popularity": 5.409281326081194,
                "confidence": 1,
                "confidence_city_level": 1,
                "confidence_street_level": 1,
                "match_type": "full_match",
            },
            "place_id": "51d8b4af3f8f0e1a4059709692e5a4ae4940f00102f9010df1001300000000c00203",
        },
        {
            "query": {
...
RES_TEST_BATCH_REVERSE_GEOCODE = [
    [{
        "query": {"lon": 7.010232, "lat": 51.450216},
        "datasource": {
            "sourcename": "openstreetmap",
            "attribution": "© OpenStreetMap contributors",
            "license": "Open Database License",
        ...
        "address_line1": "DB Schenker",
        "address_line2": "Kruppstraße 4, 45128 Essen, Germany",
        "rank": {"importance": 0.29952189898097165, "popularity": 8.464778201466588},
        "place_id": "51d009d51bab0a1c4059e6f16a6fa6b94940f00101f901bb0771000000000092030b444220536368656e6b6572e203246f70656e7374726565746d61703a76656e75653a72656c6174696f6e2f37343037353437",
    },
        {
            "query": {"lon": 4.3649087, "lat": 50.8512746},
            "datasource": {
                "sourcename": "openstreetmap",
                "attribution": "© OpenStreetMap contributors",
                "license": "Open Database License",
            ...
            "address_line2": "Rue Royale - Koningsstraat 103, 1000 City of Brussels, Belgium",
            "category": "building",
            "rank": {"importance": 0.2533630197666373, "popularity": 8.756741365970566},
    ...
    [{
        "query": {"lon": 30.215443, "lat": 50.554534},
        "datasource": {
            "sourcename": "openstreetmap",
            "attribution": "© OpenStreetMap contributors",
            "license": "Open Database License",
